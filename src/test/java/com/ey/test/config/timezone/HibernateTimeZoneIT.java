package com.ey.test.config.timezone;

import com.ey.test.Test8App;
import com.ey.test.repository.timezone.DateTimeWrapper;
import com.ey.test.repository.timezone.DateTimeWrapperRepository;
